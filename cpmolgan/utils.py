...
from rdkit.Chem import AllChem, Draw, MACCSkeys, rdFMCS, MolStandardize, Descriptors, MolFromSmiles
...
def generate_scaffold_OLD(smiles, include_chirality=False, generic=False):
